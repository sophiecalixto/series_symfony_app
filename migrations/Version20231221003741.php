 ...
 */
final class Version20231221003741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE season (id INT NOT NULL, series_id INT DEFAULT NULL, number SMALLINT NOT NULL, PRIMARY KEY(id))');
